public class product
{
	  ...
	  public static void main(String[] args){
	        ...
	        System.out.println("Define a class ‘product’ with data members pcode, pname and price. Create 3 objects ofthe classand find the product having the lowest price.");
